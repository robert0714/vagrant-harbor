...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "harbor-registry" do |d| 
    d.vm.box = "ubuntu/trusty64"
    d.vm.hostname = "harbor-registry"
#    d.vm.network "private_network", ip: "10.100.98.200"
    d.vm.network "public_network", bridge: "eno4", ip: "192.168.57.48", auto_config: "false", netmask: "255.255.255.0" , gateway: "192.168.57.1"
